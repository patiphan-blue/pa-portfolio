...
const participationReport = "งานทะเบียนและวัดผลผ่านระบบ SGS, DMC\nจัดทำเอกสาร ปพ.3 และการเทียบโอนผลการเรียน\n\nงานโสตทัศนูปกรณ์ของโรงเรียน\nดูแลเครื่องเสียงและอำนวยความสะดวกห้องประชุมธนี\n\nงานพัสดุ\nจัดทำระบบบัญชีพัสดุ ดูแลระบบแจกโครมบุ๊ค และจัดทำระบบตรวจสอบการชำระเงินค่าเทอมของนักเรียน";
...
const defaults = {
  ...
  rounds: {
    1: {
      participationSummary: participationReport,
