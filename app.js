...
const defaults = {
  ...
  rounds: {
    ...
    2: {
      challengeTitle: "การยกระดับชิ้นงานวงจรอิเล็กทรอนิกส์ด้วยกระบวนการแก้ปัญหาและ AI อย่างมีวิจารณญาณ",
      challengeProblem: "หลังจากมีทักษะพื้นฐานแล้ว ผู้เรียนยังต้องพัฒนาความสามารถในการออกแบบวงจรและโปรแกรมจากโจทย์ใหม่ รวมถึงการตรวจสอบความถูกต้องของคำแนะนำจาก AI",
      challengeMethod: "ให้ผู้เรียนเลือกโจทย์ ออกแบบและจำลองวงจร เขียนโปรแกรม ทดสอบ แก้ข้อผิดพลาด และบันทึกพัฒนาการผ่านเว็บแอป โดยใช้ AI เป็นคู่คิดภายใต้หลักการตรวจสอบแหล่งข้อมูล ทดลองจริง และอธิบายสิ่งที่ตัดสินใจด้วยตนเอง",
      challengeResult: "ผู้เรียนสร้างชิ้นงานที่ทำงานได้จริง อธิบายวงจรและโปรแกรมของตนเองได้ แก้ปัญหาเป็นขั้นตอน และแสดงหลักฐานการใช้ AI อย่างรับผิดชอบ",
      challengeQuantitative: "กำหนดจำนวนนักเรียนหรือร้อยละของผู้เรียนที่สร้างชิ้นงานผ่านเกณฑ์",
      challengeQualitative: "ผู้เรียนสร้างชิ้นงานที่ทำงานได้จริง แก้ปัญหาเป็นขั้นตอน และแสดงหลักฐานการใช้ AI อย่างรับผิดชอบ"
    }
  },
  schedule: [
...
function renderChallengePreview() {
  const items = evidence.filter(item => item.round === state.round && item.category === "challenge").slice(0, 3);
  document.querySelector("#challengePreview").innerHTML = items.map(item => `<img src="${item.src}" alt="${escapeHTML(item.title)}" data-preview-id="${item.id}">`).join("");
}
